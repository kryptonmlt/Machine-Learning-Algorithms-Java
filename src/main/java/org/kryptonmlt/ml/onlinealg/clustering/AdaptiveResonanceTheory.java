package org.kryptonmlt.ml.onlinealg.clustering;

import java.util.ArrayList;
import java.util.List;
import org.kryptonmlt.ml.onlinealg.utils.ConversionUtils;
import org.kryptonmlt.ml.onlinealg.utils.VectorUtils;
import org.kryptonmlt.ml.Clustering;

public class AdaptiveResonanceTheory implements Clustering {
    ...
    public AdaptiveResonanceTheory(double row, double alpha, double clusteringAlpha) {
        this.row = row;
        this.alpha = alpha;
